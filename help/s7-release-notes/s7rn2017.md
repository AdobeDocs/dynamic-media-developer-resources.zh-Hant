...
seo-description: Adobe Dynamic Media Classic的最新發行說明，是Adobe Experience Cloud中Adobe Experience Manager解決方案的一部分。
seo-title: 動態媒體發行說明
title: 動態媒體發行說明
...
Adobe Dynamic Media Classic的最新發行說明，是Adobe Experience Cloud中Adobe Experience Manager解決方案的一部分。

## 動態媒體發行說明 {#topic-1f5af440670a42f3bbb662eb86a196c6}

Adobe Dynamic Media Classic的最新發行說明，是中解決方 [!DNL Adobe Experience Manager] 案的一部分 [!DNL Adobe Experience Cloud]。
...
* [動態媒體影像伺服6.3.2和影像演算6.3.2](s7rn2017.md#section-19a3e96f52c74757bcdea0f8a11001f2)
...
如需完整檔案，請參閱 [http://help.adobe.com/en_US/scene7/using/index.html](http://help.adobe.com/en_US/scene7/using/index.html)
...
## 檢視器(Image Serving 5.8.1) {#section-e1940d4cedc641bca93236b4c1e0cfa7}

如需完整檔案，請參 [閱動態媒體檢視器參考指南](https://marketing.adobe.com/resources/help/en_US/s7/viewers_ref/)。
...
* 新增在eCatalog檢視器中，在行動裝置上以縱向模 `initialframe` 式使用參數指定左頁和右頁的能力。
