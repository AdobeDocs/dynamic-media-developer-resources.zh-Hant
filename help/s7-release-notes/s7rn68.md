...
此最新發行說明說明[!DNL Adobe Marketing Cloud]中[!DNL Adobe Scene7 Publishing System] 6.8-part Adobe Experience Manager解決方案的最新功能、增強功能和修正。
...
* [動態媒體影像服務檢視器5.0.1的發行說明](s7rn68.md#section-3fc1a827bcc84c0488229d310086ad8e)
...
* 已刪除預設角色。
* 除了可透過伺服器目錄上傳(ftp)和上傳URL將內容上傳至Scene7 Publishing System外，您現在也可以使用HTTP POST來上傳內容。 如需使用HTTP POST的詳細資訊，請參閱[影像生產系統API](/help/aem-ips-api/c-overview.md)。
...
## 動態媒體影像服務檢視器5.0.1 {#section-3fc1a827bcc84c0488229d310086ad8e}的發行說明
...
## Scene7 SDK 2.7.1 {#section-b82b4f546ce44a769e94fb1493511035}中的新功能和錯誤修正
