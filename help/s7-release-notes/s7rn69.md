...
**Scene7 HTML5 Viewer SDK 2.8.1**&#x200B;的新功能、增強功能和錯誤修正
...
* 新增支援，以使用HTML5彈出式檢視器的`zoomfactor`修飾元來控制影像的升級。
...
* 海報影像可能遇到「大小上限」錯誤。 因此，您必須增加「影像伺服」Publish的限制設定。
