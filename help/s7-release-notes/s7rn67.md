...
<!--   [More information](http://help.adobe.com/zh_TW/scene7/using/WS08F62297-36A5-4c35-9D4E-5BE38C41D39C.html). -->

* 已新增在上傳和使用新的批次集型別&#x200B;**多軸迴轉集**&#x200B;進行重新處理時，自動產生多軸2D迴轉集的功能。

<!--   [More information](http://help.adobe.com/zh_TW/scene7/using/WSf6ef983f54a76485-20cc30b112624e7b244-7fff.html). -->
...
<!--
 [Viewer preset compatibility matrix](http://help.adobe.com/zh_TW/scene7/using/WS6E593DEA-7D81-4cd6-84B0-85E8BB274176.html).

[Adding captions to eVideo](http://help.adobe.com/zh_TW/scene7/using/WS98ca2e6790647c06-6f6f53e137b959f094-8000.html).
-->
**中繼資料**
...
<!--   [Personal Setup](http://help.adobe.com/zh_TW/scene7/using/WSCAAE9C8A-F172-43a8-B134-6163E7C80218.html). -->

如果納入使用者定義的欄位有助於您執行中繼資料搜尋，您可以選取此選項而加以開啟。 作為替代方法，使用&#x200B;**進階搜尋**&#x200B;允許比包含所有使用者定義的欄位更直接且更快速的搜尋。

<!--   [Advanced search](http://help.adobe.com/zh_TW/scene7/using/WS259993e42159a215-1c6a66df1265272619e-7ff5.html). -->
