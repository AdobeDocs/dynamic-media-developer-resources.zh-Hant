...
<table id="table_E78C924E34894CD7BE080C0D71500784"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>設定</span>上的高解析度預先載入到<span class="uicontrol">會以高品質載入已設定的影格範圍。 啟用此設定可能會大幅增加頻寬使用量和頁面載入時間。 </p> </td>
  </tr>
 </tbody>
</table>
...
<table id="table_8B704CC077304CE2AC3E616D40B64CEF"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 自上次修改檔案後，刪除上傳資料夾工作中的暫存檔案之前的等待時間（以秒為單位）。 </p> <p><span class="codeph"> &lt;= 0 </span>的值可防止刪除暫存檔。 預設值為3600。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> autoset.dupcheck.sleep.time </span> </p> </td> 
   <td colname="col2"> <p>預設值為100。 </p> </td>
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> autoset.dupretry.counter </span> </p> </td> 
   <td colname="col2"> <p>預設值為3。 </p> </td>
  </tr> 
 </tbody> 
</table>
...
* 修正s7sdk.browser.device.version偵測到第五個™錯誤的問題。
