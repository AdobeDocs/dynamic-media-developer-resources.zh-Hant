---
description: 縮圖的垂直對齊。 指定縮圖影像在回覆影像矩形中的垂直對齊方式，這些矩形由wid=和hei=或屬性DefaultThumbPix指定。
seo-description: 縮圖的垂直對齊。 指定縮圖影像在回覆影像矩形中的垂直對齊方式，這些矩形由wid=和hei=或屬性DefaultThumbPix指定。
