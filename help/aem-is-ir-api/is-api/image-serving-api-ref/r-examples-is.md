---
description: 此頁連結到多個Image Server示例。
seo-description: 此頁連結到多個Image Server示例。
seo-title: 影像伺服器範例
...
* [著色](http://crc.scene7.com/is-docs/examples/colorize.htm)
...
* [視圖大小](http://crc.scene7.com/is-docs/examples/view-size.htm)
