...
圖層邊界矩形內的透明和半不透明區域會在*、 `opac=`、 `rotate=`和套 `extend=` 用指定顏色。

## 屬性 {#section-19dfc13e997f4a33889a1df1e4ad50b9}

層屬性。 應用於當前層，或應用於層0（如果） `layer=comp`。 被效果圖層忽略。
...
請 [參閱color=](../../../../../is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-color-commandref.md#reference-b044954ec6184253b8831579466b4423)。
