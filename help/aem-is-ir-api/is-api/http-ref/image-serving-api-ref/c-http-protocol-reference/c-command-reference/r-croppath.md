...
<table id="table_598304852E844456AB3AC9FF1F178B71"> 
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>嵌入層源映像中的路徑名（僅限ASCII）。 </p> <p> <span class="codeph"><span class="varname"> pathName</span></span> 是嵌入層源映像中的路徑的名稱。 根據需要自動變換路徑以保持與影像內容的相對對齊。 如果指定了多 <span class="codeph"><span class="varname"> 個pathName</span></span> ，伺服器會裁切到每個路徑的邊界框，一次裁切一個。 源映 <span class="codeph"><span class="varname"> 像中</span></span> ，未找到的任何pathName都將被忽略。 </p> </td> 
  </tr> 
 </tbody> 
</table>
...
層屬性。 應用於當前圖層或複合影像（如果） `layer=comp`。 被效果圖層忽略。
