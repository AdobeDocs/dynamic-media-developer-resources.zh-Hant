...
<table id="simpletable_0697E3BCB45F41C494D93A6017ADD2BF"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>設為0可分別套用至每個色彩元件，或設為1僅套用至影像亮度（強度）。 </p> <p><span class="codeph"> <span class="varname"> 單色</span></span> 會忽略灰階影像。 </p> </td> 
 </tr> 
</table>
