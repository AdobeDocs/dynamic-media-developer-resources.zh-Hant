...
<table id="simpletable_8C9DB0DA5F2B4C068794415602B768CB"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>名稱前置詞有 <span class="codeph"> 屬性：指 </span> 影像目錄屬性。 </p> </td> 
 </tr> 
 <tr class="strow"> 
  <td class="stentry"> <p> <span class="codeph"> 目錄：:Item </span> </p> </td> 
  <td class="stentry"> <p>前置有目錄 <span class="codeph"> 的名稱：指 </span> 影像目錄資料欄位。 </p> </td> 
 </tr> 
 <tr class="strow"> 
  <td class="stentry"> <p> <span class="codeph"> icc::Item </span> </p> </td> 
  <td class="stentry"> <p>前置詞有 <span class="codeph"> icc的名稱：指 </span> ICC色彩描述檔映射中的欄位。 </p> </td> 
 </tr> 
 <tr class="strow"> 
  <td class="stentry"> <p> <span class="codeph"> 字型：:Item </span> </p> </td> 
  <td class="stentry"> <p>名稱前置詞有 <span class="codeph"> 字型： </span> 指字型圖中的欄位。 </p> </td> 
 </tr> 
 <tr class="strow"> 
  <td class="stentry"> <p> <span class="codeph"> 宏：:項目 </span> </p> </td> 
  <td class="stentry"> <p>以宏為前置詞 <span class="codeph"> 的名稱： </span> 指宏定義表中的欄位。 </p> </td> 
 </tr> 
 <tr class="strow"> 
  <td class="stentry"> <p> <span class="codeph"> 規則集：：項目 </span> </p> </td> 
  <td class="stentry"> <p>前置詞為規則集 <span class="codeph"> 的名稱： </span> 指URL前處理規則集中的元素。 </p> </td> 
 </tr> 
 <tr class="strow"> 
  <td class="stentry"> <p> <span class="codeph"> 預設值：:Item </span> </p> </td> 
  <td class="stentry"> <p>預設值為前置 <span class="codeph"> 的名稱： </span> 指預設影像目錄的屬性。 </p> </td> 
 </tr> 
 <tr class="strow"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>可選 <span class="varname"> 語 </span> 法元素可重複無或多次。 </p> </td> 
 </tr> 
 <tr class="strow"> 
  <td class="stentry"> <p> <span class="codeph"> <span class="varname"> 項目1 </span>|項 <span class="varname"> 目2 </span></span> </p> </td> 
