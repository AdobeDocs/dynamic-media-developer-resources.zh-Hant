---
title: 分層概觀
description: 「影像伺服」允許將任意數量的影像、文字和純色圖層合併成複合影像。
...
* [範本](/help/aem-is-ir-api/is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-templates/c-templates.md)
...
* [錨點=](/help/aem-is-ir-api/is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-anchor.md)
* [文字路徑=](/help/aem-is-ir-api/is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-textpath.md)
