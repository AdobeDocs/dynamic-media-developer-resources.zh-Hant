---
description: 這些命令可用於定義圖層效果，如投影效果或發光效果。 效果層忽略所有其他命令。
...
# 層效果命令{#layer-effect-commands}

這些命令可用於定義圖層效果，如投影效果或發光效果。 效果層忽略所有其他命令。
...
<table id="simpletable_3094B9783772437FAACF9B382F7A32EE"> 
 ...
 <tr class="strow"> 
  <td class="stentry"> <p> <a href="../../../../../../is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-effect.md#reference-b1296c4afed047fb921bbc1e33752135" type="reference" format="dita" scope="local"> 影響</a> </p></td> 
  <td class="stentry"> <p>啟動效果圖層段並指定z階。 </p></td> 
 </tr> 
 <tr class="strow"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>讓效果更加惡化。 </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>增大或縮小層效果。 </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>為效果添加噪音。 </p></td> 
 </tr> 
 <tr class="strow"> 
