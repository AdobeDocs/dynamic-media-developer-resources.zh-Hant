---
description: 這些命令適用於在簡單請求或影像層中使用的源影像，以及附加到實色層的蒙版。
...
這些命令適用於在簡單請求或影像層中使用的源影像，以及附加到實色層的蒙版。
...
<table id="simpletable_86AF12F2BD0B4F8698A008F8A20BAEF0"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>指定單獨的源影像掩碼。 </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>指定源影像掩碼或Alpha通道使用情況。 </p></td> 
 </tr> 
 <tr class="strow"> 
