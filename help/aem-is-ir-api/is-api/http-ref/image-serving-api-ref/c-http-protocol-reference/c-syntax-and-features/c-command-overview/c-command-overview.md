---
description: 「影像伺服」支援的指令列於下方，依粗略類別分組。 有關使用和適用性的詳細資訊，請參閱特定命令說明。
seo-description: 「影像伺服」支援的指令列於下方，依粗略類別分組。 有關使用和適用性的詳細資訊，請參閱特定命令說明。
seo-title: 影像伺服HTTP通訊協定命令總覽
...
* [圖層效果命令](r-layer-effect-commands-and-attributes.md)
