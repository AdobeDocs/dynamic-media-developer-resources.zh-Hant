...
# 為靜態（非影像）內容提供服務{#serving-static-non-image-content}

影像服務提供一種機制，用於管理目錄中的非影像內容並通過單獨的 `context /is/content`。 該機制允許單獨配置每個項的TTL。
...
<table id="simpletable_4A6249F0C40747339524323EB0831CE4"> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p> <span class="codeph"> http:// <span class="varname"> 伺服器 </span>/is/content[/ <span class="varname"> 目錄 </span>/ <span class="varname"> 物料 </span>][? <span class="varname"> 修飾 </span>] </span> </p> </td> 
 </tr> 
 <tr class="strow"> 
...
Image Service支援/is/content上的以下命令：
...
<table id="table_3B111EC3AA1044FB9B659FD54BADDC39"> 
 ...
 <tbody> 
  ...
  <tr valign="top"> 
   ...
   <td> <p> 此內容項的TTL;屬性：：如果未指定或為空，則使用到期 </p> </td> 
  </tr> 
  <tr valign="top"> 
   <td> <p> <span class="codeph"> 目錄：:TimeStamp </span> </p> </td> 
   <td> <p> 檔案修改時間戳；啟用基於目錄的驗證時必需：:CacheValidationPolicy </p> </td> 
  </tr> 
  <tr valign="top"> 
   <td> <p> <span class="codeph"> 目錄：:UserData </span> </p> </td> 
   <td> <p> 與此靜態內容項關聯的可選元資料；可供客戶端使用req=userdata </p> </td> 
  </tr> 
  <tr valign="top"> 
   <td> <p> <span class="codeph"> 目錄：:UserType </span> </p> </td> 
   <td> <p> 可選資料類型；可用type=命令篩選靜態內容的請求 </p> </td> 
  </tr> 
 </tbody> 
</table>
