...
<table id="simpletable_9EBE66066E854ABE978F8F7ADC66BDE3"> 
 <tr class="strow"> 
  <td class="stentry"> <p><span class="codeph"> 顏 <span class="varname"> 色</span></span> </p></td> 
  <td class="stentry"> <p> <span class="codeph">{{<span class="varname"> gray</span>[,<span class="varname"> alpha</span>][g]}|</span> </p> <p> <span class="codeph"> {<span class="varname"> red</span>green<span class="varname"> ,</span>blue<span class="varname"> [,rgbAlpha</span><span class="varname"></span>][r]}|</span> </p> <p> <span class="codeph"> {<span class="varname"> 青色</span>，洋紅色 <span class="varname"> ,</span><span class="varname"> ，黑</span>色色[, <span class="varname"></span>α]k}|</span> </p> <p> <span class="codeph"> {0x{hex2|hex4}[g]}|</span> </p> <p> <span class="codeph">{[0x]{<span class="varname"> hex6</span>|hex8<span class="varname"></span>}[r]}|</span> </p> <p> <span class="codeph"> {[0x]{hex<span class="varname"> 8</span>|hex10<span class="varname"></span>}k}[s]</span> </p> </td> 
 </tr> 
 <tr class="strow"> 
  <td class="stentry"> <p><span class="codeph"> 紅色 <span class="varname"> 、</span>綠色 <span class="varname"> 、</span>藍色 <span class="varname"> 、</span><span class="varname"> rgb Alpha</span></span> </p> </td> 
  <td class="stentry"> <p>顏色元件值（0...255，小數點） </p> </td> 
 </tr> 
 <tr class="strow"> 
  <td class="stentry"> <p><span class="codeph"> 青 <span class="varname"> 色</span><span class="varname"> ，洋紅色</span>，黃 <span class="varname"> 色，</span><span class="varname"></span><span class="varname"> α色</span></span> </p></td> 
...
&#39;s&#39;尾碼指定顏色值與與顏色值的像素類型（定義為）對應的輸入（源）顏色空 `attribute::IccProfileSrc*`間關聯。 如果此尾碼不存在，則顏色值與輸出（目標）顏色空間(定義為或 `icc=` )相 `attribute::IccProfile*`關聯。
...
當輸出顏色的像素類型與輸 `icc=` 出影像的像素類型相對應時，使用指定的輸出顏色空間會被應用，而不是預設顏色空間。
