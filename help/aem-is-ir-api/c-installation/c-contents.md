---
title: 目錄
description: 安裝後，install_root中的資料夾層次結構包括下面列出的檔案和資料夾。
...
安裝後，install_root中的資料夾層次結構包括下面列出的檔案和資料夾。
...
<table id="table_F9FE5E0622A54CCD88461078FD5EA3DC"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col3"> </td> 
   <td colname="col4"> <p>映像服務配置檔案以前安裝的備份。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
  ...
  <tr> 
   ...
   <td colname="col4"> <p>Image Serving影像轉換器實用程式。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
   <td colname="col2"> </td> 
   <td colname="col3"> <p> <span class="filepath"> PsLayers(.exe) </span> </p> </td> 
   <td colname="col4"> <p>[!DNL Photoshop] 文字層變數擷取。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
   <td colname="col2"> </td> 
  ...
  <tr> 
   ...
   <td colname="col3"> </td> 
   <td colname="col4"> <p>資料快取資料夾；可在安裝時設定，或透過手動編輯組態檔進行設定。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
   <td colname="col2"> </td> 
  ...
  <tr> 
   ...
   <td colname="col4"> <p>影像呈現會將編譯的目錄資料儲存在此處。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
   <td colname="col2"> </td> 
  ...
  <tr> 
   ...
   <td colname="col3"> </td> 
   <td colname="col4"> <p>IS影像目錄資料夾；可在安裝時設定，或透過手動編輯組態檔進行設定。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
   <td colname="col2"> </td> 
  ...
  <tr> 
   ...
   <td colname="col4"> <p> <span class="codeph"> Default.ini </span> 需要伺服器才能正常運作。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
  ...
  <tr> 
   ...
   <td colname="col3"> </td> 
   <td colname="col4"> <p>Image Serving源資料夾；手動編輯組態檔。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
   <td colname="col2"> <p> <span class="filepath"> 記錄檔/ </span> </p> </td> 
   <td colname="col3"> </td> 
   <td colname="col4"> <p>所有PS和IS日誌資料都寫入此資料夾；手動編輯組態檔。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
   <td colname="col2"> </td> 
   <td colname="col3"> <p> <span class="filepath"> access-*.log </span> </p> </td> 
   <td colname="col4"> <p>HTTP存取記錄。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
   <td colname="col2"> </td> 
  ...
  <tr> 
   ...
   <td colname="col3"> </td> 
   <td colname="col4"> <p>在此部署Java™ Web應用程式（包括is-docs、ir-docs和is-viewers）。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="filepath"> 影像呈現/ </span> </p> </td> 
   <td colname="col2"> </td> 
   <td colname="col3"> </td> 
   <td colname="col4"> <p>影像呈現安裝根資料夾。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
   <td colname="col2"> <p> <span class="filepath"> 備份/ </span> </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <span class="filepath"> 目錄/ </span> </p> </td> 
   <td colname="col3"> </td> 
   <td colname="col4"> <p>影像呈現目錄資料夾；可在安裝時設定，或透過手動編輯組態檔進行設定。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
   <td colname="col2"> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <span class="filepath"> default-profiles/ </span> </p> </td> 
   <td colname="col3"> </td> 
   <td colname="col4"> <p>包含影像呈現的預設設定檔。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
   <td colname="col2"> <p> <span class="filepath"> 資源/ </span> </p> </td> 
   <td colname="col3"> </td> 
   <td colname="col4"> <p>影像呈現源資料資料夾；手動編輯組態檔。 </p> </td> 
  </tr> 
 </tbody> 
</table>
