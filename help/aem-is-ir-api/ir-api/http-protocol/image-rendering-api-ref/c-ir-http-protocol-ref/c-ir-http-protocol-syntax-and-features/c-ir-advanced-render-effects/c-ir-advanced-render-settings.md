---
title: 高級呈現設定
description: Vignette創作工具(Dynamic Media影像創作軟體包的一部分)提供了控制視頻渲染引擎低級部分的機制。
...
# 高級呈現設定{#advanced-render-settings}

Vignette創作工具(Dynamic Media影像創作軟體包的一部分)提供了控制視頻渲染引擎低級部分的機制。

>[!NOTE]
>
>「渲染設定」是「影像渲染」和「影像創作」的高級功能。 在使用「呈現設定」時，請與Adobe技術支援或Adobe咨詢代表聯繫，以進行培訓、咨詢或兩者。

這些設定在影像創作中以交互方式控制。 可以使用 `rs=` 命令(或 `catalog::RenderSettings` 值)。 此機制用於為每個材料選擇不同的銳化選項，並修改光照渲染算法的行為，如改變高光的飽和度或陰影中的對比度。

## 高級渲染設定(rs=)值 {#section-d9e7f341ebd44f07a4e90f1f5910726b}
...
<table id="table_1517FC39C7344EBB9F17BE20415DB057"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>「渲染效果/替代著色器」(Render Effects/Alternate Shader)將覆蓋視圖中的設定。 </p> </td> 
   <td colname="col3"> <p>0 </p> </td> 
   <td colname="col4"> <p>1 </p> </td> 
   <td colname="col5"> <p>A0=渲染效果 </p> <p>A1=備用著色器 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>U </p> </td> 
   <td colname="col2"> <p>USM（UnSharp掩碼）。 </p> </td> 
   <td colname="col3"> <p>0 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col5"> <p> 
     <ul id="ul_87184BB93E7F46D59BA1AAAFA8455512"> 
      ...
      <li id="li_42ACFCE65B4843ACAFA6A52255364642">超級取樣（預設值） </li> 
      <li id="li_34EC85C4D15145DF80F7D3DB7B6244D3">蘭喬斯窗 </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>超採樣：隨機速率。 </p> </td> 
   <td colname="col3"> <p>1 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>自適應調整大小：深度。 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>自適應調整大小：寬度。 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>突出顯示飽和度。 </p> </td> 
   <td colname="col3"> <p>0 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>基於光澤的外推強度。 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>亮度補償（複選框） </p> </td> 
   <td colname="col3"> <p> </p> </td> 
   <td colname="col4"> <p> </p> </td> 
   <td colname="col5"> <p>預設值為on（空），取消選擇= F100G0。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
   <td colname="col2"> </td> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>-100 </p> </td> 
   <td colname="col4"> <p>100 </p> </td> 
   <td colname="col5"> <p>請參閱上面值中的「xx」。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>k </p> </td> 
   <td colname="col2"> <p>光照調整。 </p> </td> 
   <td colname="col3"> <p>0 </p> </td> 
   <td colname="col4"> <p>255 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>陰影色相偏移。 </p> </td> 
   <td colname="col3"> <p>0 </p> </td> 
   <td colname="col4"> <p>255 </p> </td> 
   <td colname="col5"> <p>格式不同：8.1.2.3.4.5.6.7.8.8.1.2.3.4.5.6.7.8。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>v&amp;t </p> </td> 
   <td colname="col2"> <p>突出顯示色調偏移。 </p> </td> 
   <td colname="col3"> <p>0 </p> </td> 
   <td colname="col4"> <p>255 </p> </td> 
...
## 示例高級呈現設定 {#section-56528569eae44ecd997a289b211ff256}
...
<table id="table_062DCF66ACCC4A6997E3CA951C0A12B8"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>影像創作中的預設值。 
     <ul id="ul_AA7CF1A3E6984B318265BBE8FFFBB4EE">
      <li> USM1
      <li id="li_8EC075956E2E4D5A91355122DC9BC938">H60 =亮材料的陰影(50-100)。 </li> 
      <li id="li_F760B65E057146A7B56673D6B1A9A304">I30 =亮點(0-100)。 </li> 
      <li id="li_376C275FDB3548958C09BD266C77318F">J10 =高光飽和度(0-50)。 </li> 
      ...
      <li id="li_6B2EEEE7F0D54E078462AAFC4E4FAB42">U1 = USM（非銳化蒙版）(0-2)。 </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_C6E6DD90ECAB4D2B9284A25A29923DC6"> 
      ...
      <li id="li_A003B68023424DCABBF3A2CAF98C39A4">所有最大值和亮度補償都開啟。 </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_AAEC098CED1C436E933B1C1B88DFB659"> 
      ...
      <li id="li_E36886FB1D00444CBA19D7245E89B292">所有最大和亮度補償都已關閉。 </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_6BB668C6C055493DAAA38F4D3B9C20A7"> 
      ...
      <li id="li_DA685F4DE4BA427BA7BE241A75C96152">所有最大和亮度補償都已關閉。 </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_7C374842312E4AD0B62692BBCE6743A8"> 
      ...
      <li id="li_518C6A690EC34614B0806A0C6BC535FF">J40 =高光飽和度 </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>具有銳化的替代著色器： </p> <p> 
     <ul id="ul_93AD53BB37EA47F6A3CEE424D3AAE18C"> 
      ...
      <li id="li_E5ED76998C0543D8A3F9AD178CFD3C2C">重採樣（超採樣，隨機=半，速率=半） </li> 
      <li id="li_CCEE53544E7D48858398BF3168F1E87D">對比度（更強） </li> 
      <li id="li_EB0D25C095FB4D5798AC031AB759849B">飽和度調整（沿邊的中間、第二頂點、第三頂點中間點低） </li> 
      <li id="li_5C2304DA4A4D4799AE5DCCCB1E2ECBB3">銳化（右側為3/4） </li> 
     </ul> </p> </td> 
  </tr> 
 </tbody> 
</table>
