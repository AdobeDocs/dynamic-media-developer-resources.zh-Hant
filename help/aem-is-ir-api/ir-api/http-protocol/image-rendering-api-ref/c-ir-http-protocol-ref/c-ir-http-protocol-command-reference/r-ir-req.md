...
seo-description: 請求類型. 指定請求的資料類型。
seo-title: requin
...
<table id="simpletable_D04D41FBB03D4992B257CCBAD7EF0E7B"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>傳回暈映的 <span class="codeph"> 內容：:UserData </span>。 </p> </td> 
 </tr> 
</table>
...
執行指定的命令並返回渲染的影像。 回復資料格式和響應類型由確定 `fmt=`。

`imageprops`

傳回URL路徑中指定暈映檔案或目錄項目的選取屬性。 如需 [回覆語法](../../../../../ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-response-data/c-ir-properties.md#concept-e99f1a373eae4af9b41842ca0088ad3a) 和回應MIME類型的說明，請參閱屬性。 請求中的其他命令將被忽略。 傳回下列屬性：
...
<table id="table_A30296D29B5D43F1B5383A887252C6B4"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>字串 </p> </td> 
   <td colname="col3"> <p>修改日期／時間(來 <span class="codeph"> 自目錄：:TimeStamp </span> 或暈映檔案)。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Real </p> </td> 
   <td colname="col3"> <p>物件解析度的最 <a href="../../../../../ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-syntax-and-features/c-ir-vignettes/c-ir-material-resolution.md#concept-f60103c64e324e2cae78bd76dfb4de8b" type="concept" format="dita" scope="local"> 大單位 </a> 為材質解析度（通常為像素／英吋）。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> vignette.res.avg </span> </p> </td> 
   <td colname="col2"> <p>Real </p> </td> 
   <td colname="col3"> <p>平均物件解析 <a href="../../../../../ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-syntax-and-features/c-ir-vignettes/c-ir-material-resolution.md#concept-f60103c64e324e2cae78bd76dfb4de8b" type="concept" format="dita" scope="local"> 度單位 </a> (通常為像素/ <a href="../../../../../ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-syntax-and-features/c-ir-vignettes/c-ir-material-resolution.md#concept-f60103c64e324e2cae78bd76dfb4de8b" type="concept" format="dita" scope="local"> 包含材質解析 </a>度h)。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> vignette.res.min </span> </p> </td> 
   <td colname="col2"> <p>Real </p> </td> 
   <td colname="col3"> <p>物件解析度的最 <a href="../../../../../ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-syntax-and-features/c-ir-vignettes/c-ir-material-resolution.md#concept-f60103c64e324e2cae78bd76dfb4de8b" type="concept" format="dita" scope="local"> 小單位 </a> 為（通常為像素／英吋）。 </p> </td> 
  </tr> 
  <tr> 
...
地圖資料不會縮放至或 `wid=` 以其 `hei=` 他方式修改。 響應MIME類型為 `<text/xml>`。

回應資料由包含一組 `<map>` 元素的元素組成， `<area>` 類似於HTML標 `<AREA>` 記。

每個 `<area>` 元素都包含標準 `type=` 和屬 `coord=``name=` 性，以及一個屬性，指定暈映群組名稱或名稱路徑。 如果 `<area>` 對應對象組的掩模具有不連續區域，則存在多個具有相同名稱的元素。

除了預設屬性外，暈映還可定義其他屬性（如果已編寫）。 此類自定義屬性被定義為對象組屬性。 自定義屬性的名稱必須以開頭 `map`。 將被包含在元素 `<area>` 中。 例如，如果群組屬性包含， `map.href=http://www.scene7.com`則對應的元 `<area>` 素將包含 `href="http://www.scene7.com"`。

如果暈映不包含對 `<map>` 應資料，則會傳回空白元素的XML檔案。

`object`

執行指定的命令並返回由剩餘對象選擇(請求中最後一個或命令選擇的組或對 `sel=` 像) `obj=` 所遮罩的渲染影像。 通常與支援alpha的影像格式一起使用(請 [參見fmt=](../../../../../ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-command-reference/r-ir-fmt.md#reference-4c743f67d56b47c5b774fcc900ff758c))。 如果使用不支援alpha的影像格式，遮色片外的區域會是黑色。

`props`

執行指定的命令並返回暈映屬性和組或對象屬性，而不是渲染的影像。 如需 [回覆語法](../../../../../ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-response-data/c-ir-properties.md#concept-e99f1a373eae4af9b41842ca0088ad3a) 和回應MIME類型的說明，請參閱屬性。 除非也指定或 `obj=` 指定 `sel=` ，否則套用預設選擇(請參 [ 見 `obj=`](../../../../../ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-command-reference/r-ir-obj.md#reference-31e7dac7931b4e0eb3c7589f120a1e6a))。
...
<table id="table_F3ECF0584F6247A2A75C1CAFE1C57A4E"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p> 布林 </p> </td> 
   <td> <p>如果ICC描述檔將內嵌在回覆影像中，則為true(請參 <span class="codeph"> 閱 <a href="../../../../../ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-command-reference/r-ir-iccembed.md#reference-47a433138c7c4b29b9b29871b2491a7f" type="reference" format="dita" scope="local"> iccEmbed= </a></span>)。 </p> </td> 
  </tr> 
  <tr> 
   <td> <p> <span class="codeph"> image.iccProfile </span> </p> </td> 
   <td> <p> 字串 </p> </td> 
   <td> <p> 與回覆影像關聯之描述檔的捷徑名稱(請參 <span class="codeph"> 閱 <a href="../../../../../ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-command-reference/r-ir-icc.md#reference-86a2fff3cef24982ad2063d977a16e06" type="reference" format="dita" scope="local"> icc= </a></span>)。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> <p> 布林 </p> </td> 
   <td> <p> 如果回覆影像包含路徑資料，則為true(請參 <span class="codeph"> 閱 <a href="../../../../../ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-command-reference/r-ir-pathembed.md#reference-dfff01079fc74dbd896362cc740d7f5f" type="reference" format="dita" scope="local"> pathEmbed= </a></span>)。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> <p>整數，布林值 </p> </td> 
   <td> <p> JPEG品質和色度標幟(請參 <span class="codeph"> 閱 <a href="../../../../../ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-command-reference/r-ir-qlt.md#reference-27b91c226eb241d0a14a29af3b3afdbd" type="reference" format="dita" scope="local"> qlt= </a></span>) </p> </td> 
  </tr> 
  <tr> 
   <td> <p> <span class="codeph"> image.type </span> </p> </td> 
   <td> <p> 字串 </p> </td> 
   <td> <p> 回覆影像的MIME類型(請參 <span class="codeph"> 閱 <a href="../../../../../ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-command-reference/r-ir-fmt.md#reference-4c743f67d56b47c5b774fcc900ff758c" type="reference" format="dita" scope="local"> fmt= </a></span>)。 </p> </td> 
  </tr> 
  <tr> 
...
返回的內容 `vignette::UserData`。 伺服器將用行終結器( `'??'` )替 `vignette::UserData` 換所有出現的位 `<cr><lf>`置。 回覆的格式為文字資料，回應MIME類型設定為&lt;text/plain>。

如果URL路徑中指定的物件無法解析為有效的暈映對應項目，或者 `vignette::UserData` 為空白，則回覆將只包含行終結器( `CR/LF`)。
