---
description: TIFF編碼格式。 指定TIFF影像的壓縮格式（實際上是fmt=命令第三個值的預設值）。
seo-description: TIFF編碼格式。 指定TIFF影像的壓縮格式（實際上是fmt=命令第三個值的預設值）。
...
TIFF編碼格式。 指定TIFF影像的壓縮格式（實際上是fmt=命令第三個值的預設值）。
