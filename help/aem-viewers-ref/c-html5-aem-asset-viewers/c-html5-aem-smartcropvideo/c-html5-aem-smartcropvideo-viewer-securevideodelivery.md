...
* 如果發佈帶有嵌入代碼的Dynamic Media視頻，則添加 `SmartCropVideoPlayer.ssl` 嵌入代碼段中其他查看器配置參數的清單。 例如，要強制HTTPS視頻傳送，請追加 `&SmartCropVideoPlayer.ssl=on` 如下例所示：
