...
「關閉」按鈕工具提示和對話方塊標題可以本地化。 如需詳細資訊，請參閱[使用者介面元素的本地化](../../../c-html5-aem-asset-viewers/c-html5-aem-smartcropvideo/r-html5-aem-smartcropvideo-viewer-localization.md#concept-1d5ca2d8480f4064a51eddba13940aad)。

範例 — 若要設定包含邊框間距的對話方塊標題，請以24 x 17畫素圖示和16點粗體標題顯示。 最後，還有28 x 28畫素的「關閉」按鈕，從上方放置兩個畫素，從對話方塊容器右側放置兩個畫素：
...
按鈕工具提示可本地化。 如需詳細資訊，請參閱[使用者介面元素的本地化](../../../c-html5-aem-asset-viewers/c-html5-aem-smartcropvideo/r-html5-aem-smartcropvideo-viewer-localization.md#concept-1d5ca2d8480f4064a51eddba13940aad)。
...
對話方塊標籤可以本地化。 如需詳細資訊，請參閱[使用者介面元素的本地化](../../../c-html5-aem-asset-viewers/c-html5-aem-smartcropvideo/r-html5-aem-smartcropvideo-viewer-localization.md#concept-1d5ca2d8480f4064a51eddba13940aad)。
...
>[!NOTE]
>
>此訊息支援具有以下可能值的`state`屬性選擇器： `verifyerror`、`senderror`和`sendsuccess`。 當訊息因內嵌輸入驗證失敗而顯示時，會設定值`verifyerror`。 當後端電子郵件服務回報錯誤時，會設定值`senderror`。 成功傳送電子郵件時會設定`sendsuccess`值。 如此一來，即可根據對話方塊狀態，以不同方式設定訊息樣式。

錯誤訊息可本地化。 如需詳細資訊，請參閱[使用者介面元素的本地化](../../../c-html5-aem-asset-viewers/c-html5-aem-smartcropvideo/r-html5-aem-smartcropvideo-viewer-localization.md#concept-1d5ca2d8480f4064a51eddba13940aad)。

範例 — 若要設定訊息以使用10點粗體字型，請在左側使用25畫素行高和20畫素邊框間距。 此外，請使用驚歎號圖示，如果有錯誤則使用紅色文字，如果有成功則使用無圖示和綠色文字：
