...
<table id="table_7B5DD9303EF44ADD847B13FFEAD135D9"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> 視頻播放器 </span> </p> </td> 
   <td colname="col2"> <p> <span class="codeph"> s7sdk.video.VideoPlayer </span> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> 互動式色板 </span> </p> </td> 
   <td colname="col2"> <p> <span class="codeph"> s7sdk.set.InteractiveStables </span> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> 呼叫到操作 </span> </p> </td> 
...
使用SDK API時，必須使用正確、完全限定的SDK命名空間，如中所述 [查看器SDK命名空間](../../../c-html5-aem-asset-viewers/c-html5-aem-int-video/c-html5-aem-int-video-html5-viewer-sdk-namespace.md#concept-4ee8657c7d67421f8e7880130a246621)。
