...
使用SDK API時，請務必使用[檢視器SDK名稱空間](../../../c-html5-aem-asset-viewers/c-html5-aem-int-video/c-html5-aem-int-video-html5-viewer-sdk-namespace.md#concept-4ee8657c7d67421f8e7880130a246621)中所述的正確、完整SDK名稱空間。
