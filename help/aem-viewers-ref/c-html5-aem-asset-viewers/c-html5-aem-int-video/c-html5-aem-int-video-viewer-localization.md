---
title: 使用者介面元素的本地化
description: Interactive Video Viewer所顯示的某些內容必須經過本地化。 此類內容包含使用者介面元素工具提示，以及在視訊無法播放時顯示的錯誤訊息。
...
Interactive Video Viewer所顯示的某些內容必須經過本地化。 此類內容包含使用者介面元素工具提示，以及在視訊無法播放時顯示的錯誤訊息。

檢視器中可本地化的每個文字內容，都會以名為SYMBOL的特殊檢視器SDK識別碼表示。 任何SYMBOL都有隨現成可用的檢視器提供的英文地區設定( `"en"`)的預設相關文字值。 您也可以視需要為多個地區設定使用者定義的值。
...
<table id="table_58C40353B7244335872350C98DF2CFB3"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 選取的可變磁碟區。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 取消選取隱藏式字幕按鈕狀態。 </p> </td> 
  </tr> 
  <tr> 
