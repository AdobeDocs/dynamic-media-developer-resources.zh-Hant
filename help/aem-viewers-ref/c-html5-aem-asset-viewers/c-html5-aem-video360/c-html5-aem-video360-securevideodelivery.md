...
>[!NOTE]
>
>HTTP安全視訊傳送僅適用於安裝[功能套件-13480](https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/featurepack/cq-6.2.0-featurepack-13480)的AEM 6.2，以及安裝[功能套件NPR-15011](https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq610/featurepack/cq-6.1.0-featurepack-15011)的AEM 6.1。
...
根據您在AEM中使用的發佈動態媒體視訊方法，`Video360Player.ssl`組態屬性的套用方式與下列所示不同：

* 如果您使用URL發佈動態媒體影片，請將`Video360Player.ssl`附加至URL。 例如，若要強制安全傳送視訊，請將`&Video360Player.ssl=on`附加至下列檢視器URL範例的結尾：
...
* 如果您使用內嵌程式碼發佈動態媒體視訊，請將`Video360Player.ssl`新增至內嵌程式碼片段中其他檢視器組態參數的清單。 例如，若要強制HTTPS視訊傳送，請依下列範例附加`&Video360Player.ssl=on`:
