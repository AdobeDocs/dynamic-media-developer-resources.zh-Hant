...
<table id="table_7B5DD9303EF44ADD847B13FFEAD135D9"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> 視頻360播放器 </span> </p> </td> 
...
使用SDK API時，必須使用正確的完全限定的SDK命名空間，如中所述 [查看器SDK命名空間](../../../c-html5-aem-asset-viewers/c-html5-aem-video360/c-html5-aem-video360-viewer-sdk-namespace.md#concept-4ee8657c7d67421f8e7880130a246621)。

查看 *HTML5查看器SDK API* 的子菜單。
