...
` [Video360Player.|<containerId>_video360Player.]posterimage=none|[? *`是命令`*]`

<table id="table_C616483932C2482CA9794DDD7313FD7C"> 
 <tbody> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> none|[?<span class="varname"> 是命令</span>]</span> </p> </td> 
   <td colname="col2"> <p> 控制海報影像外觀的Image Serving修飾符。 如果在URL中指定，則HTTP-encode如下： </p> <p> 
     ...
     </ul> </p> <p> 此修飾符適用於在Dynamic Media Classic或Dynamic MediaAdobe Experience Manager主持的視頻內容。 </p> <p>要防止顯示預設海報影像，請指定 <span class="codeph"> 無</span> 作為海報影像值。 </p> </td> 
  </tr> 
 </tbody> 
</table>
