...
「關閉」按鈕工具提示和對話框標題可以本地化。 請參 [閱使用者介面元素的本地化](../../../c-html5-aem-asset-viewers/c-html5-aem-video360/c-html5-aem-video360-localization.md#concept-16262b8096474d6c9c018c3e99110dd1)。

**範例** -若要設定對話方塊標題，包含間距、22 x 12像素圖示、粗體16點標題和28 x 28像素的「關閉」按鈕，該按鈕位於對話方塊容器頂端的兩個像素和右側的兩個像素：
...
**示例** -要設定具有64 x 34 Cancel按鈕的對話框腳注，其文本顏色和背景顏色對每個按鈕狀態都不同：
...
**範例** -若要將主對話方塊區域設定為300像素高、10像素邊界，並使用白色背景：
...
所有表單內容（例如標籤和輸入欄位）都位於由下列CSS類別選擇器控制的容器內：
...
對話框標籤可以本地化。 請參 [閱使用者介面元素的本地化](../../../c-html5-aem-asset-viewers/c-html5-aem-video360/c-html5-aem-video360-localization.md#concept-16262b8096474d6c9c018c3e99110dd1)。
