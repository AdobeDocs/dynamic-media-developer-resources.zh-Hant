---
title: 上一張幻燈片
description: 按一下或點擊此按鈕將用戶返回到旋轉軸集中的上一張幻燈片。 此按鈕未顯示在觸摸設備上。 可以使用CSS調整此按鈕的大小、外觀和位置。
...
選擇此按鈕將返回用戶到旋轉軸集中的上一張幻燈片。 此按鈕未顯示在觸摸設備上。 可以使用CSS調整此按鈕的大小、外觀和位置。
...
<table id="table_94EE3F5BBE4547C0B4943471CEE7EDE4"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>從查看器邊框的左側位置。 </p> </td> 
  </tr> 
  <tr> 
...
例如，假設您要設定一個上一個60 x 60像素的幻燈片按鈕。 您希望它從左查看器邊框和垂直居中放置十個像素。 而且，你希望它為四個不同的按鈕狀態顯示不同的影像。
