---
description: 檢視器版本注意事項(5.10.1)
solution: Experience Manager
title: 檢視器版本注意事項(5.10.1)
...
## 5.10.1 {#section-f55c5ff7f6d0406c8739de4981dd7195}的新功能和增強功能

* 新增ARIA角色和屬性以支援輔助技術。
* 為視訊檢視器新增「預先載入」修飾元，以控制視訊內容預先載入。
* 已移除對flash串流播放的支援。

## 5.10.1 {#section-50e7ea1e01dd4e1fa9c8b3e00eb002b4}的錯誤修正

* 已解決iOS裝置上IFRAME版面的問題。
* 已解決XSS問題。

## 5.10.1 {#section-af67bc1734844f31a89a09004b558c6e}的已知問題和限制
