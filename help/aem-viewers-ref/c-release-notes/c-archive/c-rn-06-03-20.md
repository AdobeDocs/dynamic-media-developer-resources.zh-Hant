---
title: Dynamic Media觀眾發佈說明(5.13.1)
...
# 查看者發行說明(5.14.1){#viewers-release-notes}
...
* 用於3D預覽和交付的DimensionalViewer。
* 在嵌入式模式下運行時，在SmartCropVideoViewer中改進了智慧視頻裁剪。
* 添加了對FlyoutViewer、ZoomVerticalViewer和MixedMediaViewer的高解析度螢幕的支援（使用內聯縮放時）。
