...
## 新功能與變更 {#section-405e47e202e54943bd843d82415c91cb}
...
* 已新增 `SetIndicator` 至MixedMediaViewer，以視覺化方式呈現行動裝置上的色票。
* 已新 `getComponent` 增API，以允許外部存取檢視器元件。
