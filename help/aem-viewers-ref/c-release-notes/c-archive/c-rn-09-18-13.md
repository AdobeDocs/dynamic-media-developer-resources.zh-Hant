...
* 新的IE安全性修補程式需要使用者在IE中啟動Flash和其他ActiveX®應用程式。 如需因應措施的資訊，請參閱®網站。
...
* 檢視器內嵌於HTTPS頁面時產生例外狀況錯誤。 問題是因為與伺服器記錄檔的通訊所造成。 如需詳細資訊[https://www.adobe.com/tw/products/flashplayer/end-of-life.html](https://www.adobe.com/tw/products/flashplayer/end-of-life.html)。
