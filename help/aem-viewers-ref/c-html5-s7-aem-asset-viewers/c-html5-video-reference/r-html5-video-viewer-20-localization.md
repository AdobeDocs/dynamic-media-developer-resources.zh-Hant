---
description: 視訊檢視器顯示的某些內容可能會受到當地語系化的限制。 此內容包括使用者介面元素工具提示和無法播放視訊時顯示的錯誤訊息。
seo-description: 視訊檢視器顯示的某些內容可能會受到當地語系化的限制。 此內容包括使用者介面元素工具提示和無法播放視訊時顯示的錯誤訊息。
...
視訊檢視器顯示的某些內容可能會受到當地語系化的限制。 此內容包括使用者介面元素工具提示和無法播放視訊時顯示的錯誤訊息。
...
<table id="table_58C40353B7244335872350C98DF2CFB3"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>取消選取的播放暫停按鈕狀態的工具提示。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>視訊筆畫工具提示。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>取消選定可變體積塊的刀具提示。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>選取全螢幕按鈕狀態的工具提示。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>取消選取的隱藏字幕按鈕狀態的工具提示。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>電子郵件分享按鈕的工具提示。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>內嵌分享按鈕的工具提示。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> EmbedShare.HEADER  </span> </p> </td> 
   <td colname="col2"> <p>內嵌對話方塊標題的工具提示。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>連結對話方塊標題的工具提示。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Twitter分享按鈕的工具提示。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> VideoPlayer.ERROR  </span> </p> </td> 
   <td colname="col2"> <p>無法播放視訊時出現錯誤訊息的工具提示。 </p> </td> 
  </tr> 
 </tbody> 
</table>
