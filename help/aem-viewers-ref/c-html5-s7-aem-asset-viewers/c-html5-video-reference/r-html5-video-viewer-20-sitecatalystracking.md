---
description: 視訊檢視器支援Adobe Analytics立即可用的追蹤功能。
...
視訊檢視器支援Adobe Analytics立即可用的追蹤功能。
...
若要與協力廠商分析系統整合，必須接聽`trackEvent`檢視器回呼，並視需要處理回呼函式的`eventInfo`引數。 以下代碼是此類處理程式函式的示例：
