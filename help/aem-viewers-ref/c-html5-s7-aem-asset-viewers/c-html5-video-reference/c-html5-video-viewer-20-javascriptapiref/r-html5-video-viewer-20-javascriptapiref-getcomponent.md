...
使用SDK API時，請務必如 [Viewer SDK命名空間所述，使用正確的完全限定SDK](../../../c-html5-s7-aem-asset-viewers/c-html5-video-reference/r-html5-video-viewer-20-namespace.md#concept-679bfabb3e3e4c12a285c4e9c4144153)命名空間。
