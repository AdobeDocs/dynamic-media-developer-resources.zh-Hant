...
範例 — 若要設定含邊框間距的對話方塊標題，請選取24 x 14畫素圖示、粗體16點標題。 最後，還有28 x 28畫素的關閉按鈕，從上方放置兩個畫素，從對話方塊容器右側放置兩個畫素：
...
對話方塊標籤工具提示可以本地化。 如需詳細資訊，請參閱[使用者介面元素的本地化](../../../c-html5-s7-aem-asset-viewers/c-html5-video-reference/r-html5-video-viewer-20-localization.md#concept-1d5ca2d8480f4064a51eddba13940aad)。
...
範例 — 若要設定內嵌程式碼，以便使用`break-word`文字換行：
