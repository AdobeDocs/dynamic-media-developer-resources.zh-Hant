...
description: 彈出式檢視器的主要類別是FlyoutViewer。 這會在s7viewers名稱空間中宣告。 此JavaScript API涵蓋此特定類別的建構函式、方法和回呼。
...
彈出式檢視器的主要類別是FlyoutViewer。 這會在s7viewers名稱空間中宣告。 此JavaScript API涵蓋此特定類別的建構函式、方法和回呼。

在下列所有範例中， `<instance>` 代表JavaScript檢視器物件的實際名稱，該物件是從 `s7viewers.FlyoutViewer` 類別。

* [處置](r-html5-flyout-viewer-20-javascriptapiref-dispose.md)
* [彈出式檢視器](r-html5-flyout-viewer-20-javascriptapiref-flyoutviewer.md)
