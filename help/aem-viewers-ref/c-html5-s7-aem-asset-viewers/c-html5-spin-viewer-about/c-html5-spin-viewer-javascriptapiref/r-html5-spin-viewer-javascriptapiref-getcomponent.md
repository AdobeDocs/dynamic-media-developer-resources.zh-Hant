...
使用SDK API時，請務必依照 [Viewer SDK中所述，使用正確、完全限定的SDK命名空間](../../../c-html5-s7-aem-asset-viewers/c-html5-spin-viewer-about/c-html5-spin-viewer-namespace.md#concept-fa293878c9ff4758ae888415c70fbeef)。
