---
description: 此按鈕可讓檢視器在使用者點按時進入或退出全螢幕模式。 如果檢視器在快顯模式下運作，且系統不支援原生全螢幕，則不會顯示此按鈕。 您可以使用CSS來調整此按鈕的大小、外觀和位置。
seo-description: 此按鈕可讓檢視器在使用者點按時進入或退出全螢幕模式。 如果檢視器在快顯模式下運作，且系統不支援原生全螢幕，則不會顯示此按鈕。 您可以使用CSS來調整此按鈕的大小、外觀和位置。
seo-title: 全螢幕按鈕
...
此按鈕可讓檢視器在使用者點按時進入或退出全螢幕模式。 如果檢視器在快顯模式下運作，且系統不支援原生全螢幕，則不會顯示此按鈕。 您可以使用CSS來調整此按鈕的大小、外觀和位置。
