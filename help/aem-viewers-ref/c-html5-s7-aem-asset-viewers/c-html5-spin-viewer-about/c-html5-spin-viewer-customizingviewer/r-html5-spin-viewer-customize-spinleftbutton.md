---
title: 向左迴轉按鈕
description: 按一下或點選此按鈕，可將影像旋轉至主檢視的左側。 為了節省熒幕空間，此按鈕不會顯示在行動電話上。 此外，使用多維度迴轉集時會隱藏按鈕。 您可以使用CSS調整按鈕的大小、外觀和位置。
...
按一下或點選此按鈕，可將影像旋轉至主檢視的左側。 為了節省熒幕空間，此按鈕不會顯示在行動電話上。 此外，使用多維度迴轉集時會隱藏按鈕。 您可以使用CSS調整按鈕的大小、外觀和位置。

<!--<a id="section_061E550C1C1D4DB2BD663A898895B38C"></a>-->

**迴轉按鈕的CSS屬性**

按鈕會新增至由CSS類別選取器DIV控制的內部容器：
...
範例 — 設定28 x 28畫素的左迴轉按鈕，該按鈕位於內部容器的左邊緣。 最後，針對四種不同按鈕狀態分別顯示不同影像：
