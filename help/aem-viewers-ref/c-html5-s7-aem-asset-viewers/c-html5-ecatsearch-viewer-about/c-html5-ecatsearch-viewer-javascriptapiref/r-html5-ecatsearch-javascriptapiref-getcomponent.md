...
使用SDK API時，請務必如 [Viewer SDK命名空間所述，使用正確的完全限定SDK](../../../c-html5-s7-aem-asset-viewers/c-html5-20-ecatalog-viewer-about/c-html5-20-ecatalog-html5-viewer-sdk-namespace.md#concept-16ce67bfbdc64ffc8fc7ad174f208f05)命名空間。

如需特 *定元件的詳細資訊，請參閱Viewer SDK API* documentation。
