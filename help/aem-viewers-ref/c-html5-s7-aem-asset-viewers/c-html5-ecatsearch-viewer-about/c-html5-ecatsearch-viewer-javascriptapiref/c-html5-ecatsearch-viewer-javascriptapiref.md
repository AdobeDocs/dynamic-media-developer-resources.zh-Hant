...
seo-description: eCatalog搜尋檢視器的主要類別為eCatalogSearchViewer。 會在s7viewers命名空間中宣告。 此JavaScript API涵蓋此特定類別的建構函式、方法和回呼。
...
在下列所有範例中， `<instance>` 代表從類別實例化的JavaScript檢視器物件的實際名 `s7viewers.eCatalogSearchViewer` 稱。
