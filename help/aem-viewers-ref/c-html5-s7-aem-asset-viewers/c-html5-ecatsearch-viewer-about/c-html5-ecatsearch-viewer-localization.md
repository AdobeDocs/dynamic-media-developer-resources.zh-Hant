...
<table id="table_58C40353B7244335872350C98DF2CFB3"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>在用戶開始輸入搜索文本之前，搜索輸入框內顯示的本地化提示。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> SearchPanel.INFO_PROMPT </span> </p> </td> 
   <td colname="col2"> <p>首次開啟搜索面板時顯示的本地化消息，建議用戶執行搜索。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> SearchPanel.INFO_NO_RESULTS </span> </p> </td> 
   <td colname="col2"> <p>搜索未返回任何結果時顯示的本地化消息。 </p> <p>此符號支援以下運行時替換標籤： <span class="codeph"> $SEARCH_TEXT$ </span>。 該元件用用戶輸入的搜索文本替換它。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> SearchPanel.INFO_RESULTS </span> </p> </td> 
   <td colname="col2"> <p>成功完成搜索並返回至少一個結果時顯示的本地化消息。 </p> <p>此符號支援以下運行時替換令牌： </p> <p> 
     <ul id="ul_30B76EAB921848069BE843A5F91F697A"> 
      ...
      <li id="li_A0FBF12344B04BF0B702A2B7473330A8"> <span class="codeph"> $HIT_COUNT$ </span>  — 找到的搜索命中總數。 </li> 
      <li id="li_9EB7B41A989B455ABEC72E052284F117"> <span class="codeph"> $PAGE_COUNT$ </span>  — 至少包含一個搜索命中的目錄頁數。 </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> SearchPanel.THUMBNAIL_LABEL </span> </p> </td> 
   <td colname="col2"> <p>搜索面板的結果縮略圖的本地化標籤。 </p> <p>此符號支援以下運行時替換令牌： </p> <p> 
     <ul id="ul_7620C59FA56544CD9CE9E49B1871BCC1"> 
      <li id="li_FAF092734B4B4B55A309413690DA3FCC"> <span class="codeph"> $PAGE$ </span>  — 頁碼。 </li> 
      <li id="li_3414176505BB4A768FB42341A315E96F"> <span class="codeph"> $PAGE_HIT_COUNT$ </span>  — 在頁面上找到的搜索結果數。 </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> SearchPanel.LABEL </span> </p> </td> 
   <td colname="col2"> <p>定義 <span class="codeph"> Aria標籤 </span> 整個搜索面板的ARIA屬性。 </p> </td> 
  </tr> 
 </tbody> 
</table>
