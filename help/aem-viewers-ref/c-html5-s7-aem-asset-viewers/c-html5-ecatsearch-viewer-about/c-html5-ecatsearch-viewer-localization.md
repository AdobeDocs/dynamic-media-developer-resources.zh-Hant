...
網頁代碼應將此類本地化對象作為配置對象的欄位值傳遞 `localizedTexts` 給查看器建構子。 另一種選擇是通過調用方法傳遞定位 `setLocalizedTexts(localizationInfo)` 對象。
...
<table id="table_58C40353B7244335872350C98DF2CFB3"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>檢視器在載入時產生的頁面標籤。 </p> <p>該符號的名稱是範本，其中 <span class="codeph"> XX是橫向方向的零位跨頁索引，可選 </span> YY <span class="codeph"> 是XX所定位跨頁內的零位頁索引 </span><span class="codeph"></span>。 </p> <p>僅適用於初始載入的資產；若使用setAsset() <span class="codeph"> API呼叫變更資產 </span> ，則忽略。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>為整個搜索面板定 <span class="codeph"> 義標籤 </span> ARIA屬性的值。 </p> </td> 
  </tr> 
 </tbody> 
</table>
