---
title: 縮放重設按鈕
description: 選取此按鈕可在主檢視中重設影像。 此按鈕會顯示在桌上型電腦系統和平板電腦的主要控制列中。 在行動電話上，此按鈕會顯示在影像的下方中央。 但是，當影像處於重設狀態時，不會顯示它。 您可以使用CSS調整此按鈕的大小、外觀和位置。
...
選取此按鈕可在主檢視中重設影像。 此按鈕會顯示在桌上型電腦系統和平板電腦的主要控制列中。 在行動電話上，此按鈕會顯示在影像的下方中央。 但是，當影像處於重設狀態時，不會顯示它。 您可以使用CSS調整此按鈕的大小、外觀和位置。
...
範例 — 設定縮放重設按鈕，其大小為28 x 28畫素，且位置（在案頭上）為從底部起4畫素，從主控列的右邊緣起47畫素。 最後，針對四種不同的按鈕狀態分別顯示不同的影像。
