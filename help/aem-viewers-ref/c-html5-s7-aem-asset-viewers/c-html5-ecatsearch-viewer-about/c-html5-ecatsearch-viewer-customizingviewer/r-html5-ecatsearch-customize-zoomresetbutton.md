...
seo-description: 按一下或點選此按鈕會重設主檢視中的影像。 此按鈕會出現在案頭系統和平板電腦的主控制列中。 在行動電話上，此按鈕會顯示在影像的中下方。 但是，當影像處於重設狀態時，不會顯示它。 您可以使用CSS來調整此按鈕的大小、外觀和位置。
seo-title: 縮放重設按鈕
...
按一下或點選此按鈕會重設主檢視中的影像。 此按鈕會出現在案頭系統和平板電腦的主控制列中。 在行動電話上，此按鈕會顯示在影像的中下方。 但是，當影像處於重設狀態時，不會顯示它。 您可以使用CSS來調整此按鈕的大小、外觀和位置。
...
<table id="table_94EE3F5BBE4547C0B4943471CEE7EDE4"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>從主控制列（在桌上型電腦和平板電腦上）或檢視器（在行動電話上）的上邊框定位，包括間距。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> 右側 </span> </p> </td> 
   <td colname="col2"> <p>從主控制列（桌上型電腦和平板電腦）或檢視器（行動電話）的右邊框定位，包括間距。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> 左側 </span> </p> </td> 
   <td colname="col2"> <p>從主控制列（在桌上型電腦和平板電腦上）或檢視器（在行動電話上）的左邊框定位，包括填補空白。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> 底部 </span> </p> </td> 
   <td colname="col2"> <p>從主控制列（在桌上型電腦和平板電腦上）或檢視器（在行動電話上）的底邊框中定位，包括填補空白。 </p> </td> 
  </tr> 
  <tr> 
...
範例——若要設定28 x 28像素的縮放重設按鈕，從主控制列底部放置4像素，從右邊緣放置47像素，並針對四個不同按鈕狀態顯示不同的影像。
