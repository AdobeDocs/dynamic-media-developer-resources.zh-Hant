---
title: 縮放重置按鈕
description: 選擇此按鈕將重置主視圖中的影像。 此按鈕顯示在台式機系統和平板電腦的主控制欄中。 在行動電話上，此按鈕顯示在影像的底部中心。 但是，當影像處於重置狀態時不顯示該影像。 可以使用CSS調整此按鈕的大小、外觀和位置。
...
# 縮放重置按鈕{#zoom-reset-button}

選擇此按鈕將重置主視圖中的影像。 此按鈕顯示在台式機系統和平板電腦的主控制欄中。 在行動電話上，此按鈕顯示在影像的底部中心。 但是，當影像處於重置狀態時不顯示該影像。 可以使用CSS調整此按鈕的大小、外觀和位置。
...
<table id="table_94EE3F5BBE4547C0B4943471CEE7EDE4"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>從主控制欄（在台式機和平板電腦上）或查看器（在行動電話上）的上邊框中定位，包括填充。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> 右側 </span> </p> </td> 
   <td colname="col2"> <p>從主控制欄（台式機和平板電腦）或查看器（行動電話）的右邊框定位，包括填充。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> 左側 </span> </p> </td> 
   <td colname="col2"> <p>從主控制欄（在台式機和平板電腦上）或查看器（在行動電話上）的左邊框中定位，包括填充。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> 底部 </span> </p> </td> 
   <td colname="col2"> <p>從主控制欄（在台式機和平板電腦上）或查看器（在行動電話上）的底邊框中定位，包括填充。 </p> </td> 
  </tr> 
  <tr> 
...
示例 — 設定一個縮放重置按鈕，該按鈕為28 x 28像素，並（在案頭上）從底部放置4個像素，從主控制欄的右邊緣放置47個像素。 最後，顯示四個不同按鈕狀態中每個狀態的不同影像。
