---
title: 縮放重設按鈕
description: 選取此按鈕會重設主檢視中的影像。 此按鈕顯示在案頭系統和平板電腦的主控制欄中。 在行動電話上，此按鈕會顯示在影像的底部中央。 不過，影像處於重設狀態時不會顯示。 您可以使用CSS來調整此按鈕的大小、外觀和位置。
...
選取此按鈕會重設主檢視中的影像。 此按鈕顯示在案頭系統和平板電腦的主控制欄中。 在行動電話上，此按鈕會顯示在影像的底部中央。 不過，影像處於重設狀態時不會顯示。 您可以使用CSS來調整此按鈕的大小、外觀和位置。
...
範例 — 設定28 x 28像素的縮放重設按鈕，並從底部放置（在案頭上）4像素，從主控制列的右邊放置47像素。 最後，針對四個不同的按鈕狀態顯示不同的影像。
