---
title: 「大」下一頁按鈕
description: 選擇此按鈕將用戶帶到目錄中的下一頁。 此按鈕顯示在主控制欄中。 此按鈕不顯示在手機上以保存螢幕不動產。 可以使用CSS調整此按鈕的大小、外觀和位置。
...
選擇此按鈕將用戶帶到目錄中的下一頁。 此按鈕顯示在主控制欄中。 此按鈕不顯示在手機上以保存螢幕不動產。 可以使用CSS調整此按鈕的大小、外觀和位置。
