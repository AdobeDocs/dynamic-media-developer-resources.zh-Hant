---
title: 影像地圖效果
description: 根據mode參數的值，在原本以Dynamic Media Classic製作地圖的地方，檢視器會在主檢視上顯示影像地圖圖示，或呈現與原始影像地圖形狀相符的確切區域。
...
根據mode參數的值，在原本以Dynamic Media Classic製作地圖的地方，檢視器會在主檢視上顯示影像地圖圖示，或呈現與原始影像地圖形狀相符的確切區域。
