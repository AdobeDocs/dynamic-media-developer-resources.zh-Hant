---
title: 影像映射效果
description: 根據模式參數的值，查看器將在主視圖上顯示影像映射表徵圖，這些表徵圖最初在Dynamic Media Classic創作，或呈現與原始影像映射的形狀匹配的精確區域。
...
根據模式參數的值，查看器將在主視圖上顯示影像映射表徵圖，這些表徵圖最初在Dynamic Media Classic創作，或呈現與原始影像映射的形狀匹配的精確區域。
