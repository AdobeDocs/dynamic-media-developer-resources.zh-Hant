---
title: 影像地圖效果
description: 根據mode引數的值，檢視器會在地圖最初於Dynamic Media Classic中製作的位置的主檢視上顯示影像地圖圖示。 或者，它會呈現與原始影像地圖形狀相符的精確區域。
...
根據mode引數的值，檢視器會在地圖最初於Dynamic Media Classic中製作的位置的主檢視上顯示影像地圖圖示。 或者，它會呈現與原始影像地圖形狀相符的精確區域。
