...
範例 — 若要設定28 x 28像素的電子郵件共用按鈕，並針對四個不同按鈕狀態中的每個狀態顯示不同的影像。
...
「關閉」按鈕工具提示和對話框標題可以本地化。 請參閱 [用戶介面元素本地化](../../../c-html5-s7-aem-asset-viewers/c-html5-20-ecatalog-viewer-about/c-html5-20-ecatalog-viewer-localization.md#concept-cbfc39344c494eb7b9f6a272cff0cc74) 以取得更多資訊。
...
此按鈕的工具提示可翻譯。 請參閱 [用戶介面元素本地化](../../../c-html5-s7-aem-asset-viewers/c-html5-20-ecatalog-viewer-about/c-html5-20-ecatalog-viewer-localization.md#concept-cbfc39344c494eb7b9f6a272cff0cc74) 以取得更多資訊。

範例 — 若要設定對話方塊頁尾，其中包含64 x 34取消按鈕和82 x 34傳送電子郵件按鈕。 每個按鈕狀態的文字顏色和背景顏色不同：
...
對話方塊標籤可以翻譯。 請參閱 [用戶介面元素本地化](../../../c-html5-s7-aem-asset-viewers/c-html5-20-ecatalog-viewer-about/c-html5-20-ecatalog-viewer-localization.md#concept-cbfc39344c494eb7b9f6a272cff0cc74) 以取得更多資訊。
...
範例：若要設定表單，使其具有一個像素灰色邊框，在所有輸入欄位周圍填充九個像素。 對於驗證失敗的欄位，以紅色顯示相同的邊框。 為250像素寬至欄位。 最後，其餘的輸入欄位寬300像素：
...
使用者輸入錯誤的輸入資料時，內嵌驗證失敗。 或者，當對話框在提交表單時必須呈現錯誤或確認消息時，對話框主體的頂部將顯示消息。 它由下列CSS類別選取器控制：
...
範例 — 若要設定訊息，使用十點粗體字型、25像素行高、左側邊框20像素間距，並使用驚嘆號圖示。 最後，如果出現錯誤則顯示紅色文本，如果出現成功則顯示沒有表徵圖和綠色文本：
