---
title: 縮放重置按鈕
description: 選擇或點擊此按鈕將重置主視圖中的影像。 此按鈕顯示在台式機系統和平板電腦的主控制欄中。 在行動電話上，此按鈕顯示在影像的底部中心。 但是，當影像處於重置狀態時不顯示該影像。 可以使用CSS調整此按鈕的大小、外觀和位置。
...
選擇或點擊此按鈕將重置主視圖中的影像。 此按鈕顯示在台式機系統和平板電腦的主控制欄中。 在行動電話上，此按鈕顯示在影像的底部中心。 但是，當影像處於重置狀態時不顯示該影像。 可以使用CSS調整此按鈕的大小、外觀和位置。
...
示例 — 設定一個縮放重置按鈕，該按鈕為28 x 28像素，位於（案頭上）從底部4像素，從主控制欄右邊47像素。 最後，顯示四個不同按鈕狀態中每個狀態的不同影像。
