...
<table id="table_C48C56E696304C9BAFEE71BA9EA9A174"> 
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 到左邊的下一個按鈕的距離，如果這是行中的第一個按鈕，則到控制欄的左側。 </p> </td> 
  </tr> 
  <tr> 
...
示例 — 要設定「收藏夾」菜單，該菜單位於從控制欄頂部到左側的四個像素和從最靠近的按鈕到左側的十個像素，大小為28 x 28像素：
...
示例 — 要設定「收藏夾」菜單按鈕，該按鈕顯示四個不同按鈕狀態中每個狀態的不同影像：
