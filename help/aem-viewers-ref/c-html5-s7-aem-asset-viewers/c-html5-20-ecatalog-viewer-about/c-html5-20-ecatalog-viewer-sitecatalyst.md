...
description: eCatalog Viewer支援開箱後的Adobe Analytics跟蹤。
...
eCatalog Viewer支援開箱後的Adobe Analytics跟蹤。

## 現成跟蹤 {#section-ba994f079d0343c8ae48adffaa3195a3}

eCatalog Viewer支援 [!DNL Adobe Analytics] 追蹤現場。 要啟用跟蹤，請將正確的公司預設名稱作為 `config2` 的下界。
