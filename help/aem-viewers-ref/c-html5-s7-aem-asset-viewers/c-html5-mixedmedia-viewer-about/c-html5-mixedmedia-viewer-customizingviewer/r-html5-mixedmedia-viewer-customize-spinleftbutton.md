---
description: 按一下或點選此按鈕，可在主檢視中將影像旋轉至左側。 為了儲存螢幕空間，行動電話上不會顯示此按鈕。 此外，使用多維度回轉集時，按鈕會隱藏。 您可以使用CSS來調整按鈕的大小、外觀和位置。
...
# 左轉按鈕{#spin-left-button}

按一下或點選此按鈕，可在主檢視中將影像旋轉至左側。 為了儲存螢幕空間，行動電話上不會顯示此按鈕。 此外，使用多維度回轉集時，按鈕會隱藏。 您可以使用CSS來調整按鈕的大小、外觀和位置。
...
按鈕工具提示可翻譯。 如需詳細資訊，請參閱[使用者介面元素本地化](../../../c-html5-s7-aem-asset-viewers/c-html5-mixedmedia-viewer-about/c-html5-mixedmedia-viewer-localization.md#concept-16262b8096474d6c9c018c3e99110dd1) 。

範例 — 若要設定一個回轉左鍵，此按鈕為28 x 28像素，位於內膽的左側邊緣，並針對四個不同按鈕狀態中的每個狀態顯示不同的影像：
