---
description: 顏色色票由一行縮圖影像組成，左側和右側有可選的捲動按鈕。 只有當所有縮圖無法符合容器寬度時，案頭才會顯示顏色色票。 在行動裝置上，或如果縮圖可符合容器寬度，則不會顯示捲動按鈕。
...
顏色色票由一行縮圖影像組成，左側和右側有可選的捲動按鈕。 只有當所有縮圖無法符合容器寬度時，案頭才會顯示顏色色票。 在行動裝置上，或如果縮圖可符合容器寬度，則不會顯示捲動按鈕。
