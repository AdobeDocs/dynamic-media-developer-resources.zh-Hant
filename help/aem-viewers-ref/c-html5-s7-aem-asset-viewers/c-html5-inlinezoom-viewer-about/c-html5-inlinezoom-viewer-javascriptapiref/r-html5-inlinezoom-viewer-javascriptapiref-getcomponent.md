...
傳回檢視器所使用之檢視器SDK元件的參考。 網頁可使用此方法來擴充或自訂現成檢視器的行為。 只有在 `initComplete` 檢視器回呼已執行；否則，檢視器邏輯尚未建立元件。
...
使用SDK API時，請務必如下所述，正確使用完全限定的SDK命名空間： [檢視器SDK](../../../c-html5-s7-aem-asset-viewers/c-html5-inlinezoom-viewer-about/c-html5-inlinezoom-viewer-namespace.md#concept-5af3b472b320496d87735ea612edda80).
