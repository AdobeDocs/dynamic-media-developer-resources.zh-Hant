...
使用SDK API時，必須正確使用完全限定的SDK命名空間，如中所述 [查看器SDK](../../../c-html5-s7-aem-asset-viewers/c-html5-inlinezoom-viewer-about/c-html5-inlinezoom-viewer-namespace.md#concept-5af3b472b320496d87735ea612edda80)。

有關特定元件的詳細資訊，請參閱查看器SDK文檔。
