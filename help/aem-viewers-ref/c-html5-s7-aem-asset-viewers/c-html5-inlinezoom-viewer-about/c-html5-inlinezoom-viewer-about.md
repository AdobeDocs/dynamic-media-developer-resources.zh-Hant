...
內嵌縮放檢視器是影像檢視器。 當使用者滑過或觸碰主檢視時，會顯示靜態影像，並在靜態影像上顯示縮放版本。 此檢視器可處理影像集，並使用色票進行導覽。 它可在桌上型電腦和行動裝置上運作。
...
內嵌縮放檢視器可使用隨附於影像伺服檢視器的生產就緒HTML頁面，或在內嵌模式下，使用檔案化API將它整合至目標網頁，以快顯模式使用。
...
<table id="table_ED747CC7178448919C34A4FCD18922D0"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> 在色票中啟動彈出檢視或主要和次要縮放層級之間的變更，以選取新的縮圖。 </p> </td> 
  </tr> 
  <tr> 
...
在內嵌模式下，檢視器會新增至現有的網頁，其中可能已有與檢視器無關的客戶內容。 檢視器通常只佔據網頁空間的一部分。

主要使用案例是面向桌上型電腦或平板電腦裝置的網頁，以及回應式網頁，這些網頁會根據裝置類型自動調整版面。
...
1. 建立和初始化檢視器。
   ...
   以下程式碼是內嵌固定大小之內嵌內嵌於內嵌縮放檢視器之平凡網頁的完整範例：
