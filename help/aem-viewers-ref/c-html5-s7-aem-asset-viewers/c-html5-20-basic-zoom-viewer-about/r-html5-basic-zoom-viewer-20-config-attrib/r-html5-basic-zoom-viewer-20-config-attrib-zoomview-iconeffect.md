...
<table id="table_6CAA904E976A41BD994D8926F46F0BAF"> 
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 指定IconEffect出現和重新出現的最大次數。 值-1表 <span class="codeph"> 示圖</span> 示永遠會無限期地重新顯示。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>設定IconEffect在自動隱藏前保持完全可見的秒數。 也就是說，淡入動畫完成後，淡出動畫開始之前的時間。 設定為 <span class="codeph"> 0</span> 會停用自動隱藏行為。 </p> </td> 
  </tr> 
 </tbody> 
</table>
