---
description: 重設一或多個資產的發佈狀態，以在下個發佈工作中強制重新發佈資產。
...
重設一或多個資產的發佈狀態，以在下個發佈工作中強制重新發佈資產。
...
<table id="table_742D67AD77554904976EC4A07A0CBC64"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"><span class="codeph"> <span class="varname">個重新發佈檔案</span> </span> </td> 
   <td colname="col2"><span class="codeph"> xsd：布林值</span> </td> 
   <td colname="col3"> <p>否 </p> </td> 
   <td colname="col4"> <p>指定資產的檔案會重新發佈至傳遞伺服器。 預設為<span class="codeph"> true</span>。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"><span class="codeph"> <span class="varname"> resyncCatalog</span> </span> </td> 
   <td colname="col2"><span class="codeph"> xsd：布林值</span> </td> 
   <td colname="col3"> <p>否 </p> </td> 
   <td colname="col4"> <p>指定用於提供資產的目錄中繼資料已同步，以確保其為最新狀態。 此引數用於解決相同記錄幾乎同時更新時可能發生的競爭條件。 預設為<span class="codeph"> false</span>。 </p> </td> 
  </tr> 
  <tr> 
