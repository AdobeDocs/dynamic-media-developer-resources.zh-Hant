...
<table id="table_04100BB8ABD84EF68B0A7CE3AD946414"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <span class="codeph"> xsd:double</span> </td> 
   <td colname="col3"> 範圍比較中的最小雙值（僅適用於浮點型欄位）。 </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col3"> 日期比較值（僅適用於日期輸入欄位）。 </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> </td> 
   <td colname="col3"> <p> 為元資料伺服器建立區分大小寫。 用於 <span class="codeph"> searchAssetsByMetadata</span> 呼叫。 </p> <p>請參閱 <a href="../../operations/c-operations-intro/c-methods/r-search-assets-by-metadata.md#reference-609ec73944a34ce49b152389fbb40414" format="dita" scope="local"> searchAssetsByMetadata</a>. </p> </td> 
  </tr> 
 </tbody> 
</table>
