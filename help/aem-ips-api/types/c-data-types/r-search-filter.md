---
description: 可協助您定義搜尋條件的篩選器，以提高搜尋的效率。
...
<table id="table_57CEE262A33A4E898C6AFB30C93FD874"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <span class="codeph"> type:StringArray</span> </td> 
   <td colname="col3">您要在搜尋中傳回的資產子類型清單。 例如，對於 <span class="codeph"> AssetSet</span>，您可以搜尋 <span class="codeph"> MediaType</span> 子類型。 </td> 
  </tr> 
  <tr> 
   <td colname="col1"><span class="codeph"><span class="varname"> strictSubTypeCheck</span></span> </td> 
   <td colname="col2"><span class="codeph"> xsd:boolean</span> </td> 
   <td colname="col3"> <p>此選用的布林值標幟指定是否要在 <span class="codeph"> assetSubTypeArray</span> 已傳遞。 </p> <p>若為true，則只會傳回具有其中一個指定子類型的資產。 </p> <p>如果為false，系統也會傳回沒有子類型的資產。 </p> <p>預設值為false。 </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col3">設為： 
    <ul id="ul_8C164A5D9F0F43968C86A67FA6884F35"> 
     ...
     <li id="li_4970226BF0FF42388CAE4415FB63AF16"><span class="codeph"> False</span>:傳回產生的內容。 例如，來自上傳PDF的影像。 </li> 
    </ul> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col3">指定: 
    ...
    </ul> <p>注意：留空以搜尋 <i>all</i> 已發佈狀態類型。 </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col3">指定: 
    <ul id="ul_D31B903FA8DA4CFFABAFABA3D8DA91EC"> 
     ...
     <li id="li_A1F46A0762FA4D4BA9F7247338238DC6"><span class="codeph"> InTrash</span> 從垃圾桶傳回資產。 </li> 
    </ul> </td> 
  </tr> 
 </tbody> 
</table>
