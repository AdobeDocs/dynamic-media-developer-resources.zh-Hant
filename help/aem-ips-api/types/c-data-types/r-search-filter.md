...
<table id="table_57CEE262A33A4E898C6AFB30C93FD874"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <span class="codeph"> includeSubfolders <span class="varname"> (包含子檔案夾</span> ) </span> </td> 
  ...
  <tr> 
   ...
   <td colname="col3">您要在搜尋中傳回的資產類型清單。 例如，影 <span class="codeph"> 像</span>。 </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <span class="codeph"> type:StringArray</span> </td> 
   <td colname="col3">您要在搜尋中傳回的資產子類型清單。 例如，對於 <span class="codeph"> Asset</span>，您可以搜尋 <span class="codeph"> MediaType</span> 子類型。 </td> 
  </tr> 
  <tr> 
   <td colname="col1"><span class="codeph"><span class="varname"> strictSubTypeCheck</span></span> </td> 
   <td colname="col2"><span class="codeph"> xsd:boolean</span> </td> 
   <td colname="col3"> <p>可選的布林值標幟，指定在傳遞assetSubTypeArray時，是否要傳回無子 <span class="codeph"> 類型的資產</span> 。 </p> <p>如果為true，則只會傳回具有其中一個指定子類型的資產。 </p> <p>若為false，則也會傳回無子類型的資產。 </p> <p>預設值為false。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <span class="codeph"> 排 <span class="varname"> 除副產品</span></span> </td> 
   <td colname="col2"> <span class="codeph"> xsd:boolean</span> </td> 
   <td colname="col3">設為： 
  ...
  <tr> 
   <td colname="col1"> <span class="codeph"> project <span class="varname"> Handle</span></span> </td> 
   <td colname="col2"> <span class="codeph"> xsd:string</span> </td> 
  ...
  <tr> 
   ...
   <td colname="col3">指定: 
    ...
    </ul> <p>注意：留空可搜尋所有已 <i>發佈的</i> 狀態類型。 </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col3">指定: 
    <ul id="ul_D31B903FA8DA4CFFABAFABA3D8DA91EC"> 
     <li id="li_E4386C8260E64F0BAFE5BA57FF788E48"><span class="codeph"> 任何</span> ，不論資產的垃圾狀態為何，都可傳回資產。 </li> 
     <li id="li_0B8933FE18C643828075EC8CE8C0223C"><span class="codeph"> NotInTrash</span> ，傳回'normal'資產。 </li> 
     <li id="li_A1F46A0762FA4D4BA9F7247338238DC6"><span class="codeph"> InTrash</span> ，從垃圾筒傳回資產。 </li> 
    </ul> </td> 
  </tr> 
 </tbody> 
</table>
