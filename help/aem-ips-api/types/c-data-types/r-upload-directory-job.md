...
<table id="table_6E40A78846F444BDB8E437413B90CFCE"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <span class="codeph"> <span class="varname"> 自動顏色選項</span> </span> </td> 
   <td colname="col2"> <span class="codeph"> 類型：自動顏色選項</span> </td> 
   <td colname="col3"> <p>自動影像裁剪選項（基於顏色）。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>是否在上載時建立掩碼。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <span class="codeph"> <span class="varname"> 目標資料夾</span> </span> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <span class="codeph"> xsd:string</span> </td> 
   <td colname="col3"> <p>上載時是否包含子資料夾。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>手動影像裁剪選項。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <span class="codeph"> <span class="varname"> 媒體選項</span> </span> </td> 
   <td colname="col2"> <span class="codeph"> 類型：媒體選項</span> </td> 
   <td colname="col3"> <p>用於從視頻中設定縮略圖的選項。 </p> <p>請參閱 <a href="../../types/c-data-types/r-media-options.md#reference-18618fc6803a4b6e994bbb48eba93b5b" format="dita" scope="local"> 媒體選項</a>。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <span class="codeph"> <span class="varname"> 覆蓋</span> </span> </td> 
   <td colname="col2"> <span class="codeph"> xsd:string</span> </td> 
   <td colname="col3"> <p>檔案上載覆蓋選項。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <span class="codeph"> xsd:string</span> </td> 
   <td colname="col3"> <p>檔案上載目標的URL。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <span class="codeph"> <span class="varname"> postImageRenderingPublish</span> </span>作業 </td> 
   <td colname="col2"> <span class="codeph"> 類型：ImageRendingPublishJob</span> </td> 
   <td colname="col3"> <p>上載完成後運行的影像呈現發佈作業的詳細資訊。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <span class="codeph"> <span class="varname"> postImageServingPublishJob</span> </span> </td> 
   <td colname="col2"> <span class="codeph"> 類型：ImageServingPublishJob</span> </td> 
   <td colname="col3"> <p>上載完成後運行的提供發佈作業的映像的詳細資訊。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>用於將Post Script檔案上載到映像伺服器的選項。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <span class="codeph"> <span class="varname"> postVideoPublishJob</span> </span> </td> 
   <td colname="col2"> <span class="codeph"> 類型：VideoPublishJob</span> </td> 
   <td colname="col3"> <p>上載完成後運行的視頻發佈作業的詳細資訊。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <span class="codeph"> <span class="varname"> preserveCrop</span> </span> </td> 
   <td colname="col2"> <span class="codeph"> xsd:boolean</span> </td> 
   <td colname="col3"> <p>控制對任何現有作物定義的保留。 預設為true。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <span class="codeph"> xsd:string</span> </td> 
   <td colname="col3"> <p>是否處理此作業的單獨元資料XML檔案。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <span class="codeph"> <span class="varname"> projectHandleArray</span> </span> </td> 
   <td colname="col2"> <span class="codeph"> 類型：HandleArray</span> </td> 
   <td colname="col3"> <p>項目句柄陣列。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <span class="codeph"> <span class="varname"> 就緒，發佈</span> </span> </td> 
   <td colname="col2"> <span class="codeph"> xsd:boolean</span> </td> 
   <td colname="col3"> <p>確定檔案是否已標籤為可以發佈。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <span class="codeph"> <span class="varname"> 伺服器目錄</span> </span> </td> 
   <td colname="col2"> <span class="codeph"> xsd:string</span> </td> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>使用這些可選設定提取並處理上載的TAR/ZIP檔案的內容。 </p> <p>請參閱 <a href="../../types/c-data-types/r-uncompress-options.md#reference-510ec7028b1540bc9b58745f242d49d5" format="dita" scope="local"> 取消壓縮選項</a>。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> <span class="varname"> xmp關鍵字</span> </span> </p> </td> 
